package com.wsns.lor.fragment.login;
...
public class ForgetPasswordThirdFragment extends Fragment{
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, Bundle savedInstanceState) {
        if(view == null){
            view = inflater.inflate(R.layout.fragment_password_third,null);
    ...
    void init(){
        ...
        etRepatedPassword = (EditText) view.findViewById(R.id.et_repeat_password);
