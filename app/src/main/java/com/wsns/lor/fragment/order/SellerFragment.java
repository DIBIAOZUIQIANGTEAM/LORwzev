...
import com.wsns.lor.activity.WebActivity;
import com.wsns.lor.activity.seller.LocationActivity;
import com.wsns.lor.activity.seller.SellerDetailsActivity;
...
public class SellerFragment extends Fragment implements BDLocationListener, AdapterView.OnItemClickListener, View.OnClickListener {
    ...
    int[] drawableId = {R.drawable.pc, R.drawable.repairtype_phone, R.drawable.repairtype_tv, R.drawable.repairtype_kongtiao
            , R.drawable.repairtype_bingxiang, R.drawable.repairtype_fengshan, R.drawable.repairtype_weibo, R.drawable.repairtype_else};
    String[] text = {"电脑", "手机", "电视", "空调", "冰箱", "风扇", "微波炉", "全部"};
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        headView = inflater.inflate(R.layout.seller_list_head, container,false);
    ...
    private void initBanner() {
        ...
        banner.setOnBannerListener(new OnBannerListener() {
            ...
            public void OnBannerClick(int position) {
                ...
                intent.putExtra("link",(String)linklist.get(position));
