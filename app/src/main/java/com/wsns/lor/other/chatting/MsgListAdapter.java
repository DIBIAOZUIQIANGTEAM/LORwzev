...
import com.wsns.lor.other.chatting.utils.TimeFormat;
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        if (holder.headIcon != null) {
            if (getItemViewType(position) ==  TYPE_SEND_TXT ||getItemViewType(position) ==  TYPE_SEND_IMAGE ) {
                ...
                Picasso.with(mContext).load(HttpMethods.BASE_URL +"upload/seller/"+((UserInfo)mMsgList.get(position).getTargetInfo()).getUserName()+".png").placeholder(R.drawable.unknow_avatar).error(R.drawable.unknow_avatar).into(holder.headIcon);
...
//                        intent.putExtra(LorApplication.TARGET_ID, JMessageClient.getMyInfo().getUserName());
//                        intent.setClass(mContext, MeInfoActivity.class);
//                        mContext.startActivity(intent);
//                    } else {
//                        String targetID = userInfo.getUserName();
//                        intent.putExtra(LorApplication.TARGET_ID, targetID);
//                        intent.putExtra(LorApplication.TARGET_APP_KEY, userInfo.getAppKey());
//                        intent.putExtra(LorApplication.GROUP_ID, mGroupId);
//                        intent.setClass(mContext, FriendInfoActivity.class);
//                        ((Activity) mContext).startActivityForResult(intent,
//                                LorApplication.REQUEST_CODE_FRIEND_INFO);
//                    }
                }
            });
        }
