...
import com.wsns.lor.adapter.AlbumListAdapter;
import com.wsns.lor.application.LorApplication;
import com.wsns.lor.R;
import com.wsns.lor.other.chatting.entity.ImageBean;
import com.wsns.lor.utils.SortPictureList;
...
//		mGroupGridView = (GridView) findViewById(R.id.pick_picture_total_grid_view);
		...
		mListView.setOnItemClickListener(new OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
				...
				startActivityForResult(mIntent, LorApplication.REQUEST_CODE_SELECT_ALBUM);
	...
	protected void onActivityResult(int requestCode, int resultCode, Intent data) {
		...
		if (resultCode == LorApplication.RESULT_CODE_SELECT_ALBUM) {
			setResult(LorApplication.RESULT_CODE_SELECT_PICTURE, data);
			finish();
		}
	}
