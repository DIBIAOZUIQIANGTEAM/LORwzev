...
import com.wsns.lor.other.chatting.MsgListAdapter.ViewHolder;
import com.wsns.lor.other.chatting.activity.BrowserViewPagerActivity;
import com.wsns.lor.other.chatting.entity.FileType;
            ...
            switch (msg.getContentType()) {
                ...
                case image:
                    if (holder.picture != null && v.getId() == holder.picture.getId()) {
                        ...
                        intent.putExtra(LorApplication.TARGET_ID, mConv.getTargetId());
                        intent.putExtra("msgId", msg.getId());
                        if (mConv.getType() == ConversationType.group) {
                            GroupInfo groupInfo = (GroupInfo) mConv.getTargetInfo();
                            intent.putExtra(LorApplication.GROUP_ID, groupInfo.getGroupID());
                        }
                        intent.putExtra(LorApplication.TARGET_APP_KEY, mConv.getTargetAppKey());
                        intent.putExtra("msgCount", mMsgList.size());
                        intent.putIntegerArrayListExtra(LorApplication.MsgIDs, getImgMsgIDList());
                ...
                case file:
                    ...
                    if (!TextUtils.isEmpty(content.getLocalPath())) {
                        ...
                        if (msg.getDirect() == MessageDirect.send) {
                            ...
                            final String newPath = LorApplication.FILE_DIR + fileName;
